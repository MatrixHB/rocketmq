...
public class Payment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4516018286103110065L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Payment\",\"namespace\":\"org.apache.rocketmq.example.schema\",\"fields\":[{\"name\":\"item\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"double\"}]}");
   ...
   */
  public Payment(java.lang.CharSequence item, java.lang.Double amount) {
    this.item = item;
    this.amount = amount;
  }
   ...
   */
  public static org.apache.rocketmq.example.schema.Payment.Builder newBuilder() {
    return new org.apache.rocketmq.example.schema.Payment.Builder();
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static org.apache.rocketmq.example.schema.Payment.Builder newBuilder(org.apache.rocketmq.example.schema.Payment.Builder other) {
    return new org.apache.rocketmq.example.schema.Payment.Builder(other);
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static org.apache.rocketmq.example.schema.Payment.Builder newBuilder(org.apache.rocketmq.example.schema.Payment other) {
    return new org.apache.rocketmq.example.schema.Payment.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Payment>
    ...
    private Builder() {
      super(org.apache.rocketmq.example.schema.Payment.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.apache.rocketmq.example.schema.Payment.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.apache.rocketmq.example.schema.Payment other) {
            super(org.apache.rocketmq.example.schema.Payment.SCHEMA$);
      if (isValidValue(fields()[0], other.item)) {
        this.item = data().deepCopy(fields()[0].schema(), other.item);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.rocketmq.example.schema.Payment.Builder setItem(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.rocketmq.example.schema.Payment.Builder clearItem() {
      item = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.rocketmq.example.schema.Payment.Builder setAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.rocketmq.example.schema.Payment.Builder clearAmount() {
